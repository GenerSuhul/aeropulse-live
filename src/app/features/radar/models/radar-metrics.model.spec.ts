...
const item = (isOnGround: boolean, altitudeFeet: number | null, groundSpeedKnots: number | null): Aircraft => ({ id: `${isOnGround}-${altitudeFeet}`, icao24: 'ABC123', callsign: null, registration: null, aircraftType: null, description: null, operator: null, latitude: null, longitude: null, altitudeFeet, groundSpeedKnots, headingDegrees: null, verticalRateFeetPerMinute: null, squawk: null, category: null, isOnGround, emergency: null, secondsSinceLastMessage: null, secondsSinceLastPosition: null });
